...
class SnsApi:
    ...
    def create_s_m_s_sandbox_phone_number(
        self,
        context: RequestContext,
    ...
    def delete_s_m_s_sandbox_phone_number(
    ...
    def list_s_m_s_sandbox_phone_numbers(
        self,
        context: RequestContext,
        next_token: nextToken = None,
    ...
    def verify_s_m_s_sandbox_phone_number(
        self,
        context: RequestContext,
        phone_number: PhoneNumberString,
