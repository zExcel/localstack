...
class GetDocumentationPartsRequest(ServiceRequest):
    restApiId: String
...
class ApigatewayApi:
    ...
    def get_documentation_parts(
        ...
        position: String = None,
        limit: NullableInteger = None,
        location_status: LocationStatusType = None,
    ) -> DocumentationParts:
        raise NotImplementedError
    ...
    def put_integration(
        ...
        http_method: String,
        type: IntegrationType,
        integration_http_method: String = None,
        uri: String = None,
        connection_type: ConnectionType = None,
        connection_id: String = None,
        credentials: String = None,
        request_parameters: MapOfStringToString = None,
        request_templates: MapOfStringToString = None,
        passthrough_behavior: String = None,
        cache_namespace: String = None,
        cache_key_parameters: ListOfString = None,
        content_handling: ContentHandlingStrategy = None,
        timeout_in_millis: NullableInteger = None,
