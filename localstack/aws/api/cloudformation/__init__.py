...
class CloudformationApi:
    ...
    @handler("ActivateType")
    def activate_type(
        self,
        context: RequestContext,
        type: ThirdPartyType = None,
        public_type_arn: ThirdPartyTypeArn = None,
        publisher_id: PublisherId = None,
        type_name: TypeName = None,
        type_name_alias: TypeName = None,
    ...
    def describe_type(
        ...
        version_id: TypeVersionId = None,
        publisher_id: PublisherId = None,
        public_version_number: PublicVersionNumber = None,
    ) -> DescribeTypeOutput:
        raise NotImplementedError
    ...
    @handler("ListTypeRegistrations")
    def list_type_registrations(
        self,
        context: RequestContext,
        type: RegistryType = None,
        type_name: TypeName = None,
        type_arn: TypeArn = None,
        registration_status_filter: RegistrationStatus = None,
        max_results: MaxResults = None,
        next_token: NextToken = None,
    ) -> ListTypeRegistrationsOutput:
        raise NotImplementedError

    @handler("ListTypeVersions")
    def list_type_versions(
        ...
        max_results: MaxResults = None,
        next_token: NextToken = None,
        deprecated_status: DeprecatedStatus = None,
        publisher_id: PublisherId = None,
    ...
    def list_types(
        ...
        provisioning_type: ProvisioningType = None,
        deprecated_status: DeprecatedStatus = None,
        type: RegistryType = None,
    ...
    def register_type(
        ...
        logging_config: LoggingConfig = None,
        execution_role_arn: RoleArn = None,
        client_request_token: RequestToken = None,
    ) -> RegisterTypeOutput:
        raise NotImplementedError
    ...
    @handler("SetTypeConfiguration")
    def set_type_configuration(
        self,
        context: RequestContext,
        configuration: TypeConfiguration,
        type_arn: TypeArn = None,
        configuration_alias: TypeConfigurationAlias = None,
        type_name: TypeName = None,
        type: ThirdPartyType = None,
    ) -> SetTypeConfigurationOutput:
        raise NotImplementedError

    @handler("SetTypeDefaultVersion")
    ...
    def test_type(
        ...
        type_name: TypeName = None,
        version_id: TypeVersionId = None,
        log_delivery_bucket: S3Bucket = None,
    ) -> TestTypeOutput:
        raise NotImplementedError
