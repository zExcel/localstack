...
class CreateComputeEnvironmentRequest(ServiceRequest):
    computeEnvironmentName: String
    type: CEType
    state: Optional[CEState]
    unmanagedvCpus: Optional[Integer]
...
class RegisterJobDefinitionRequest(ServiceRequest):
    jobDefinitionName: String
...
class BatchApi:
    ...
    @handler("CreateComputeEnvironment")
    def create_compute_environment(
        ...
        compute_resources: ComputeResource = None,
    ...
    def register_job_definition(
        ...
        scheduling_priority: Integer = None,
        container_properties: ContainerProperties = None,
        node_properties: NodeProperties = None,
        retry_strategy: RetryStrategy = None,
        propagate_tags: Boolean = None,
        timeout: JobTimeout = None,
        tags: TagrisTagsMap = None,
        platform_capabilities: PlatformCapabilityList = None,
